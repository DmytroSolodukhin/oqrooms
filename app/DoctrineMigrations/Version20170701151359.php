 ...
 */
class Version20170701151359 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, lat VARCHAR(255) DEFAULT NULL, lng VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quest (id INT AUTO_INCREMENT NOT NULL, user INT DEFAULT NULL, gallery_id INT DEFAULT NULL, city INT DEFAULT NULL, visible TINYINT(1) DEFAULT NULL, complexity INT DEFAULT NULL, sms TINYINT(1) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, inprogress TINYINT(1) DEFAULT NULL, startTime DATETIME DEFAULT NULL, lat VARCHAR(255) DEFAULT NULL, lng VARCHAR(255) DEFAULT NULL, maxCount INT NOT NULL, count INT DEFAULT NULL, plusPay INT DEFAULT NULL, originalBackground VARCHAR(255) DEFAULT NULL, background VARCHAR(255) DEFAULT NULL, addres VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, originalImage VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_4317F8178D93D649 (user), UNIQUE INDEX UNIQ_4317F8174E7AF8F (gallery_id), INDEX IDX_4317F8172D5B0234 (city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quest_typegame (quest_id INT NOT NULL, typegame_id INT NOT NULL, INDEX IDX_8D0D7132209E9EF4 (quest_id), INDEX IDX_8D0D71323E6B55BE (typegame_id), PRIMARY KEY(quest_id, typegame_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gallery (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, originalImage VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, gallery LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE time (id INT AUTO_INCREMENT NOT NULL, quest INT DEFAULT NULL, visit INT DEFAULT NULL, open DATETIME NOT NULL, phone VARCHAR(255) NOT NULL, inprogress TINYINT(1) DEFAULT NULL, price INT NOT NULL, count INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_6F9498454317F817 (quest), INDEX IDX_6F949845437EE939 (visit), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE typegame_quest (typegame_id INT NOT NULL, quest_id INT NOT NULL, INDEX IDX_887E61953E6B55BE (typegame_id), INDEX IDX_887E6195209E9EF4 (quest_id), PRIMARY KEY(typegame_id, quest_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE quest_typegame ADD CONSTRAINT FK_8D0D7132209E9EF4 FOREIGN KEY (quest_id) REFERENCES quest (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE quest_typegame ADD CONSTRAINT FK_8D0D71323E6B55BE FOREIGN KEY (typegame_id) REFERENCES type (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE typegame_quest ADD CONSTRAINT FK_887E61953E6B55BE FOREIGN KEY (typegame_id) REFERENCES type (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE typegame_quest ADD CONSTRAINT FK_887E6195209E9EF4 FOREIGN KEY (quest_id) REFERENCES quest (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE quest_typegame DROP FOREIGN KEY FK_8D0D7132209E9EF4');
        $this->addSql('ALTER TABLE time_history DROP FOREIGN KEY FK_733DD12D4317F817');
        ...
        $this->addSql('ALTER TABLE typegame_quest DROP FOREIGN KEY FK_887E6195209E9EF4');
        $this->addSql('ALTER TABLE quest DROP FOREIGN KEY FK_4317F8174E7AF8F');
        $this->addSql('ALTER TABLE time_history DROP FOREIGN KEY FK_733DD12D437EE939');
        $this->addSql('ALTER TABLE time DROP FOREIGN KEY FK_6F949845437EE939');
        $this->addSql('ALTER TABLE quest_typegame DROP FOREIGN KEY FK_8D0D71323E6B55BE');
        $this->addSql('ALTER TABLE typegame_quest DROP FOREIGN KEY FK_887E61953E6B55BE');
        ...
        $this->addSql('DROP TABLE quest_typegame');
        ...
        $this->addSql('DROP TABLE typegame_quest');
