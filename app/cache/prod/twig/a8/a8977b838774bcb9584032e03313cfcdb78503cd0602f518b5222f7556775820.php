...
class __TwigTemplate_9585d1655f0e9714a70ec489089dfe0aec51ca811a9f040b55502d056c02cb68 extends Twig_Template
{
    ...
    {
        // line 1
        $context["__internal_13bc3881fd465cb5a4af54eebfe0079773436f87e9d9366d00d1f85bb30b82b8"] = ($context["comur_translation_domain"] ?? null);
        // line 3
        echo "
";
        // line 4
...
($context["__internal_13bc3881fd465cb5a4af54eebfe0079773436f87e9d9366d00d1f85bb30b82b8"] ?? null));
        // line 40
        echo "</h3>
            </div>
...
";
    ...
    {
        // line 5
        if (( !array_key_exists("include_jquery", $context) || ($context["include_jquery"] ?? null))) {
            // line 6
...
";
        // line 16
        if (( !array_key_exists("include_holder", $context) || ($context["include_holder"] ?? null))) {
            // line 17
            echo "    <script src=\"https://cdnjs.cloudflare.com/ajax/libs/holder/2.5.2/holder.min.js\"></script>
";
        }
        // line 19
        if (( !array_key_exists("include_bootstrap", $context) || ($context["include_bootstrap"] ?? null))) {
            // line 20
            echo "    <script src=\"";
...
";
    ...
    {
        return new Twig_Source("", "ComurImageBundle:Form:croppable_image_modal.html.twig", "/var/www/oqroom/vendor/comur/image-bundle/Comur/ImageBundle/Resources/views/Form/croppable_image_modal.html.twig");
    }
}
