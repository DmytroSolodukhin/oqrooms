...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'oqroomsc_1', 'user' => 'oqroomsc_1', 'password' => 's0pelk132', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $a, $b, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1129cc5fea37efcfac9f58b83a9772c38b53592fde1deaf4bf30aa9e2945cf68');
        return $instance;
    }
