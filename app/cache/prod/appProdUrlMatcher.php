...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // ru__RG__web_page
        if (0 === strpos($pathinfo, '/page') && preg_match('#^/page/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__web_page')), array (  '_controller' => 'WebBundle\\Controller\\DefaultController::pageAction',  '_locale' => 'ru',));
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            if (0 === strpos($pathinfo, '/admin/core')) {
                ...
                if (0 === strpos($pathinfo, '/admin/core/t')) {
                    if (0 === strpos($pathinfo, '/admin/core/typegame')) {
                        // ru__RG__admin_core_typegame_list
                        if ($pathinfo === '/admin/core/typegame/list') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'type.quest',  '_sonata_name' => 'admin_core_typegame_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_typegame_list',);
                        }

                        // ru__RG__admin_core_typegame_create
                        if ($pathinfo === '/admin/core/typegame/create') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'type.quest',  '_sonata_name' => 'admin_core_typegame_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_typegame_create',);
                        }

                        // ru__RG__admin_core_typegame_batch
                        if ($pathinfo === '/admin/core/typegame/batch') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'type.quest',  '_sonata_name' => 'admin_core_typegame_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_typegame_batch',);
                        }

                        // ru__RG__admin_core_typegame_edit
                        if (preg_match('#^/admin/core/typegame/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_typegame_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'type.quest',  '_sonata_name' => 'admin_core_typegame_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_typegame_delete
                        if (preg_match('#^/admin/core/typegame/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_typegame_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'type.quest',  '_sonata_name' => 'admin_core_typegame_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_typegame_show
                        if (preg_match('#^/admin/core/typegame/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_typegame_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'type.quest',  '_sonata_name' => 'admin_core_typegame_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_typegame_export
                        if ($pathinfo === '/admin/core/typegame/export') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'type.quest',  '_sonata_name' => 'admin_core_typegame_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_typegame_export',);
                        }
                ...
                if (0 === strpos($pathinfo, '/admin/core/page')) {
                    // ru__RG__admin_core_page_list
                    if ($pathinfo === '/admin/core/page/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'admin.page',  '_sonata_name' => 'admin_core_page_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_page_list',);
                    }

                    // ru__RG__admin_core_page_create
                    if ($pathinfo === '/admin/core/page/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'admin.page',  '_sonata_name' => 'admin_core_page_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_page_create',);
                    }

                    // ru__RG__admin_core_page_batch
                    if ($pathinfo === '/admin/core/page/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'admin.page',  '_sonata_name' => 'admin_core_page_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_page_batch',);
                    }

                    // ru__RG__admin_core_page_edit
                    if (preg_match('#^/admin/core/page/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_page_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.page',  '_sonata_name' => 'admin_core_page_edit',  '_locale' => 'ru',));
                    }

                    // ru__RG__admin_core_page_delete
                    if (preg_match('#^/admin/core/page/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_page_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.page',  '_sonata_name' => 'admin_core_page_delete',  '_locale' => 'ru',));
                    }

                    // ru__RG__admin_core_page_show
                    if (preg_match('#^/admin/core/page/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_page_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.page',  '_sonata_name' => 'admin_core_page_show',  '_locale' => 'ru',));
                    }

                    // ru__RG__admin_core_page_export
                    if ($pathinfo === '/admin/core/page/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'admin.page',  '_sonata_name' => 'admin_core_page_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_page_export',);
                    }
