...
class Quest extends \CoreBundle\Entity\Quest implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'user', 'visible', 'complexity', 'phone', 'types', 'inprogress', 'time', 'open', 'startTime', 'city', 'lat', 'lng', 'maxCount', 'count', 'plusPay', 'originalBackground', 'background', 'addres', 'id', 'title', 'description', 'originalImage', 'image'];
        }

        return ['__isInitialized__', 'user', 'visible', 'complexity', 'phone', 'types', 'inprogress', 'time', 'open', 'startTime', 'city', 'lat', 'lng', 'maxCount', 'count', 'plusPay', 'originalBackground', 'background', 'addres', 'id', 'description', 'originalImage', 'image'];
    }
